...
class Step4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cities2 : Array<Any> = arrayOf("",1, 0.1)//*

        //String 타입의 빈 배열을 생성합니다. emptyarray는 타입추론이 불가함으로 타입을 꼭 지정 하기!!
        var emptyStringArray = emptyArray<String>()
        //emptyStringArray[0] = "a"  //안됌
        //emptyStringArray.set(0, "a") //안됌
        ...
        people.filter{it.age > 30}.filter{it.age > 25}
        people.filter{it.age > 30 && it.age > 25}
        ...
        println(languageType.reduceRight{acc, s ->
            if(s == "swift"){
                "$acc, $s"
            } else {
                ""
